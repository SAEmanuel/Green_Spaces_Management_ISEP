...
![Sequence Diagram - Partial - Get Task Category List](svg/us012-sequence-diagram-partial-get-task-category-list.svg)

**Get Task Category Object**

![Sequence Diagram - Partial - Get Task Category Object](svg/us012-sequence-diagram-partial-get-task-category.svg)
