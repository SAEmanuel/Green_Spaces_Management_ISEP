...
The proposed integrative project is an educational initiative aimed at computer engineering students, whose goal is to analyze, design and implement a computer solution to support the activity of an organization dedicated to the management of green spaces for collective use in urban environments. These spaces include gardens, parks and other green areas which, as well as providing aesthetic and recreational benefits, play a crucial role in improving the quality of urban life, promoting biodiversity and mitigating the effects of climate change. In the context of this project, we worked in teams to develop a proof of concept that involves various aspects including the management of multidisciplinary teams, the allocation of teams in green spaces, the management of fleets, machinery and other equipment, the optimization of irrigation and/or lighting systems, and the production of statistical indicators to measure the performance of the activity, being related to the planning, construction, maintenance and optimization of green spaces such as gardens and parks.  The solution to be developed should include the efficient management of multidisciplinary teams, the allocation of human and material resources, the optimization of irrigation and lighting systems and the creation of statistical indicators to assess the performance of the activities carried out.

The knowledge acquired in subjects such as Software Engineering (ESOFT), Programming Paradigms (PPROG), Computational Mathematics (MATCP), Discrete Mathematics (MDISC) and Laboratory Project II (LAPR2) will be fundamental to the success of this project. The application of good software engineering practices, including agile methodologies, will be essential to manage teamwork efficiently and guarantee the delivery of a functional, quality product. The development process will follow an iterative and incremental model, using SCRUM as the project management framework.
In this manual, the reader will find detailed information on using the solution developed, including managing teams and vehicle fleets, creating and monitoring performance indicators, analyzing statistical data, and planning irrigation systems. The manual is structured to provide clear and practical guidance to green space managers and administrators, enabling them to use the solution efficiently to improve the quality and sustainability of the spaces they manage.

The proposed solution will include an agenda system to plan the teams' weekly work, detailing the tasks to be carried out, the green spaces involved and the specific timetables. In addition, a portal will be developed to allow interaction with citizens, where they can post comments and report faults in the green spaces, promoting greater community participation in the management of urban spaces. To implement the graphical user interface, JavaFX will be used, a powerful tool that allows you to create feature-rich desktop applications. JavaFX offers a wide range of interface components, support for 2D and 3D graphics, and a flexible architecture that facilitates integration with other technologies, making it ideal for developing applications that require intuitive and visually appealing interaction.
The project is a comprehensive exercise that integrates knowledge from various disciplines, promoting the practical application of agile methodologies, test-driven development, and statistical analysis in a realistic context of urban green space management.
